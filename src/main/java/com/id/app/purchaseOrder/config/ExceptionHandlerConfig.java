package com.id.app.purchaseOrder.config;


import com.id.app.purchaseOrder.dto.ResponseDto;
import com.id.app.purchaseOrder.exthandler.*;
...
public class ExceptionHandlerConfig {
    ...
    public ResponseEntity<ResponseDto> dataAccess(HttpServletRequest req, Exception e) {
        ResponseDto errorResponse = ResponseDto.builder()
                .responseCode(HttpStatus.INTERNAL_SERVER_ERROR.value()  + ResponseCode.DATA_NOT_FOUND.getCode())
                .responseDesc(ResponseCode.DATA_NOT_FOUND.getDescription() + " - " + e.getMessage())
                .build();
        log.error("{} : {} - Data Access service for req - {}", e.getClass().getSimpleName(), e.getLocalizedMessage(), req.getRequestURL(), e);
        return ResponseEntity.status(HttpStatus.OK).body(errorResponse);
    }
    ...
    public ResponseEntity<ResponseDto> noResources(HttpServletRequest req, Exception e) {
        ResponseDto errorResponse = ResponseDto.builder()
                .responseCode(HttpStatus.INTERNAL_SERVER_ERROR.value()  + ResponseCode.METHOD_NOT_FOUND.getCode())
                .responseDesc(ResponseCode.METHOD_NOT_FOUND.getDescription() + " - " + e.getMessage())
                .build();
        log.error("{} : {} - Resource service for req - {}", e.getClass().getSimpleName(), e.getLocalizedMessage(), req.getRequestURL(), e);
        return ResponseEntity.status(HttpStatus.OK).body(errorResponse);
    }
